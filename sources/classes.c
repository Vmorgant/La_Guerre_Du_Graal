...
t_classe tab_classes[nb_classes]= {
	...
	{"Saber",3,50,3,10,5,10,10, {"coup d'épée",3,1,1,1},{"double coup",5,2,1,1}/*,ulti*/},
	{"Archer",5,50,3,10,5,10,10, {"coup d'épée",3,1,1,1},{"double coup",5,2,1,1}/*,ulti*/},
	{"Caster",2,50,3,10,5,10,10, {"coup d'épée",3,1,1,1},{"double coup",5,2,1,1}/*,ulti*/},
};
