...
t_classe tab_classes[nb_classes]= {
	...
	{"Caster",2,20,3,10,2,12,5, {"Eclair",3,1,2,1},{"Brasier",5,2,2,1}/*,ulti*/},
        {"Berserker",7,100,7,7,15,7,15, {"Frapper",3,1,1,1},{"Destruction",5,3,1,1}/*,ulti*/},
        {"Lancer",3,50,3,10,4,10,7, {"Tranpercer",3,1,2,1},{"Empaler",5,2,2,1}/*,ulti*/},
        {"Rider",3,20,3,10,2,12,5, {"Eclair",3,1,2,1},{"Brasier",5,2,2,1}/*,ulti*/},
        {"Assassin",3,20,3,10,2,12,5, {"Eclair",3,1,2,1},{"Brasier",5,2,2,1}/*,ulti*/},
};
