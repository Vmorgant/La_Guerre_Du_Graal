...
t_classe tab_classes[nb_classes]= {
	...
	{"Archer",6,30,2,7,3,15,6, {"Tir",2,1,2,1},{"Tir puissant",7,1.8,5,1}/*,ulti*/},
	{"Caster",2,20,3,10,1,5,6, {"Gandr",3,0.8,2,1},{"Brasier",5,1.4,3,1}/*,ulti*/},
        {"Berserker",10,150,2,12,4,2,18, {"Frapper",3,1,1,1},{"Destruction",9,2.3,3,2}/*,ulti*/},
        {"Lancer",4,60,2,10,4,12,8, {"Transpercer",3,1,1,1},{"Empaler",5,1.5,2,2}/*,ulti*/},
        {"Rider",3,20,3,5,3,7,1, {"Fauchage",3,1,1,1},{"TUA",4,1.3,1,1}/*,ulti*/},
        {"Assassin",3,20,5,10,4,20,4, {"Evisceration",4,1.1,1,1},{"Coupe Gorge",8,2,1,1}/*,ulti*/},
};
